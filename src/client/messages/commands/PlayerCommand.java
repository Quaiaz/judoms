...
public class PlayerCommand {
   ...
   // }
    ...
    public static class town extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, ".::::::::::: JudoMS Town Maps :::::::::::.");
    ...
    public static class pq extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, ".:::::::::::::::: JudoMS Party Quest Maps ::::::::::::::::.");
    ...
    public static class mob extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, ".:::::::::: JudoMS Monster Maps ::::::::::.");
    ...
    public static class boss extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, ".::::::::::::::::::::::: JudoMS Boss Maps :::::::::::::::::::::::.");
    ...
    public static class misc extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
             c.getPlayer().dropMessage(5, ".:::: JudoMS Miscellaneous Maps ::::.");
    ...
    public static class npc extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, ".::::::::::::::::::::: JudoMS NPC :::::::::::::::::::::.");
   ...
   public static class job extends OpenNPCCommand {
    ...
    public static class help extends CommandExecute {
        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(6, ".::::::::::::::::::::::::::::::: JudoMS Player Commands ::::::::::::::::::::::::::::::::.");
            ...
            c.getPlayer().dropMessage(6, "@uptime - Checks JudoMS Uptime.");
            ...
            c.getPlayer().dropMessage(6, "@message [message] - Messages a JudoMS staff with your enquires.");
    ...
    /** public static class side extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            String ee = "In JudoMS, we offer the ability to pick a side, light or dark to players.";
...
*/
    ...
    public static class eventrules extends CommandExecute {
     ...
     public static class Reborn extends CommandExecute {
        ...
        public static class judoms extends CommandExecute {

        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, "JudoMS Rates: 512x / 1x / 1x");
            c.getPlayer().dropMessage(5, "Version: 117.2");
            c.getPlayer().dropMessage(5, "Revision: 0.0.1");
            c.getPlayer().dropMessage(5, "Administrator: Judo");
            c.getPlayer().dropMessage(5, "Game Master: Jason");
            c.getPlayer().dropMessage(5, "Advisor: iRawr");
            c.getPlayer().dropMessage(6, "JudoMS Time: " + FileoutputUtil.CurrentReadable_TimeGMT() + " GMT + 8");
            return 1;
        }
    }
        ...
        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(6, "JudoMS has been up for " + StringUtil.getReadableMillis(ChannelServer.serverStartTime, System.currentTimeMillis()));
            return 1;
        }
    }
